...
const RcDarkMode = ({ data }) => {
  const { isOpen03, toggleModal03 } = useContext(PortfolioContext);
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="close-modal" onClick={toggleModal03}>
