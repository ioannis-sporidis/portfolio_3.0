...
const RcRandomUser = ({ data }) => {
  const { isOpen06, toggleModal06 } = useContext(PortfolioContext);
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="close-modal" onClick={toggleModal06}>
