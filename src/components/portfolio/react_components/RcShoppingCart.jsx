...
const RcShoppingCart = ({ data }) => {
  const { isOpen08, toggleModal08 } = useContext(PortfolioContext);
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="close-modal" onClick={toggleModal08}>
