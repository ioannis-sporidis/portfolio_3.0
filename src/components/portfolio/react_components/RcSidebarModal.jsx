...
const RcSidebarModal = ({ data }) => {
  const { isOpen09, toggleModal09 } = useContext(PortfolioContext);
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="close-modal" onClick={toggleModal09}>
