...
const RcPagination = ({ data }) => {
  const { isOpen05, toggleModal05 } = useContext(PortfolioContext);
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <button className="close-modal" onClick={toggleModal05}>
